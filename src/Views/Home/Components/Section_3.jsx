...
function Section_3() {
  return (
    <div className="sm:h-[17pc] mt-20 relative rounded-2xl bg-gradient-to-r from-purple-500 overflow-hidden from-10% via-pink-500 via-100% sm:p-5 p-2 flex justify-between items-center">
      ...
      <div className="h-full w-[55%] z-[] md:opacity-100 opacity-10 md:relative absolute gap-5 flex justify-betwee -rotate-12">
        <img
