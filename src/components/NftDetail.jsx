            ...
            <div className="border-l-[2px] border-r-[1px] border-b-[2px] border-darkBlue-600 flex flex-col gap-4 p-4">
              ...
              >
                <div className="">
                  ...
                  <select
                    id="countries"
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-darkBlue-500 focus:border-darkBlue-500 block w-full p-2.5 dark:bg-darkBlue-600 dark:border-gray-600/30 dark:placeholder-gray-500 dark:text-white"
                  >
